...
it also only has two colors coded into its CSS; the background color and main accent are already assigned to the variables <code>bgcolor</code> and <code>main-color</code> respectively. this will make it easier once i get around to coding a theme switcher for this website

maybe in the future i can also add more colors for things like italic text and stuff, but for now this website only has two colors lol
